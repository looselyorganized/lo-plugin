...
.dark {
  --color-cream:    #1E1E1E;                   /* Near-black background */
  ...
  --color-warning: #F59E0B;                    /* Brighter amber for contrast */
...
|-------------|------------------|------------------|------------------------------------|
| cream       | `#FBF7EB` warm parchment | `#1E1E1E` near black | Background inverts completely |
...
| warning     | `#D97706` amber          | `#F59E0B` bright amber | Caution stays visible        |
