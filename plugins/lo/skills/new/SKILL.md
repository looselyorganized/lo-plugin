...
### Step 7: Write CI Caller Workflow

Create `.github/workflows/ci.yml` (create `.github/workflows/` directory if needed):

```yaml
# Auto-generated by /lo:new — updated by /lo:status
name: CI
on:
  pull_request:
    branches: [main]
